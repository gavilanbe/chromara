...
- **Ruedita de utensilios** (tecla C, como la psinergia de Golden Sun): cada arma da una habilidad de campo, la use quien la use; gastan MP. **Empujar** (brocha): mueve gomas y trastos. **Trazar** (lápiz, 1 MP): une los puntos numerados en orden; en desorden sale un garabato que la Goma borra (tres intentos). **Regar** (pincel, 2 MP): hace brotar semillas. **Revelar** (Carmín + Añil, 3 MP cada uno): oscurece la página y muestra lo dibujado a lápiz.
- **El estuche del delineante** (esquina inferior derecha del mapa): un tintero roto mana un río de tinta húmeda. Se empuja una goma hasta taponarlo, el río se seca y se agrieta, con Revelar aparecen dos puntos ocultos, se unen los cinco en orden y forman un puente de rayas; al otro lado, regar la semilla hace brotar una enredadera que trepa el estante hasta el **estuche**, que se abre con cremallera diente a diente y entrega **la Pluma**. Dos post-its dan las pistas.
