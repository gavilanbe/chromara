...
const CACHE = 'chromara-portada-4';
const SHELL = ['./', './index.html', './manifest.webmanifest', './mobile.css', './chromara-cuaderno.ttf', './chromara-rotulo.ttf',
  './icons/icon-192.png', './icons/icon-512.png', './icons/icon-maskable-512.png',
  './data.js', './music.js', './music_cues.js', './music_fallback.js', './sfx_samples.js', './sfx.js', './audio.js', './font.js', './sprites.js', './character_sprites.js', './world_art.js',
  './rinse.js', './field.js', './scene.js', './gui.js', './battle.js', './attacks.js', './combat.js', './battle_ui.js', './settings.js', './mobile.js', './chapter_art.js', './chapters.js', './prologue.js', './game.js'];
