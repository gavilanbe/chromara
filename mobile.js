...
function updateTouchControls() {
  ...
  const ready = ['Examinar','Comprar','Pasar hoja','Seguir','Usar','Lanzar'].includes(label); if (confirm?.classList?.contains && confirm.classList.contains('is-ready') !== ready) confirm.classList.toggle('is-ready', ready);
